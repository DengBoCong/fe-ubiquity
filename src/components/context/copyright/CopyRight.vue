<template>
  <el-card class="box-card" style="width:100%;margin:0;">
    <el-popover
      placement="top-start"
      width="400"
      trigger="click">
      ...
      <el-button slot="reference" style="margin-left:550px;margin-top:-10px;">DengBoCong版权所有，保留一切权利.点击查看作者信息</el-button>
    </el-popover>
  </el-card>
</template>
